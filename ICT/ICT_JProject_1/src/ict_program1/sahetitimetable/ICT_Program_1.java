...
public class ICT_Program_1 {
    ...
    public static void main(String[] args) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            String timetablePath = "C:\\Users\\kaira\\Desktop\\ICT\\ICT_JProject_1\\TimeTables\\" + grade + homeTeacher + ".png";
            ...
            timetableFrame.setIconImage(
                    Toolkit.getDefaultToolkit().getImage("C:\\Users\\kaira\\Desktop\\ICT\\ICT_JProject_1\\Ico\\download.png"));
                ...
                if (homeTeacher.equalsIgnoreCase("MH") && grade == 10) {
                    ...
                    if (currentDayAbv.equalsIgnoreCase("Mon")) {
                        ...
                        if (currentHour == 8 && currentMinute == 50) {
                            JOptionPane.showMessageDialog(null, "You Have Maths Next");
                        }
                    ...
                    if (currentDayAbv.equalsIgnoreCase("Fri")) {
                        ...
                        if (currentHour == 12 && currentMinute == 15) {
                            JOptionPane.showMessageDialog(null, "You Can Not Take Your Second Break\nthe amount of times i typed this is unbelievable");
                        }
                        if (currentHour == 12 && currentMinute == 45) {
                        ...
                        if (currentHour == 14 && currentMinute == 15) {
                            JOptionPane.showMessageDialog(null, "You Can Go Home Now, Unless You Have Anything Else To Do With SAHETI"
                                    + "\nbut...Programer will be taking his first break in 9.5 hrs...");
                        }
                    }
                    try {
                        Thread.sleep(60000); // 1 minute = 60,000 milliseconds
    ...
    private static void minimizeToTray() {
        ...
        ImageIcon imageIcon = new ImageIcon(
                "C:\\Users\\kaira\\Desktop\\ICT\\ICT_JProject_1\\Ico\\download.png");
